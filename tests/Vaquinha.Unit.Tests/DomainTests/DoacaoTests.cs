...
namespace Vaquinha.Unit.Tests.DomainTests
{
                              ...
                              IClassFixture<CartaoCreditoFixture>
    {
        ...
        [Fact]
        [Trait("Doacao", "Doacao_UsuarioAceitaPagarComTaixa_DoacaoValida")]
        public void Doacao_UsuarioAceitaPagarComTaixa_DoacaoValida()
        {           
            // Arrange
            ...
            // Assert
            valido.Should().BeTrue(because: "os campos foram preenchidos corretamente");
            doacao.Valor.Should().Be(6, because: "valor com taixa de 20%");
            doacao.ErrorMessages.Should().BeEmpty();
        }
