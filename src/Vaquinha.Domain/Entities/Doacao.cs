...
namespace Vaquinha.Domain.Entities
{
  public class Doacao : Entity
  {
    ...
    public Doacao(Guid id, Guid dadosPessoaisId, Guid enderecoCobrancaId, double valor,
                  Pessoa dadosPessoais, CartaoCredito formaPagamento, Endereco enderecoCobranca, bool aceitaTaixa = false)
    {
      Id = id;
      ...
      Valor = aceitaTaixa ? valor * 1.2 : valor;
    ...
    public bool AceitaTaixa { get; private set; }
